...
import { c as ClmmPoolInfo, N as TickArray, T as TickArrayBitmapExtensionType, n as ClmmPoolRewardLayoutInfo, b as ClmmPoolRewardInfo, y as ReturnTypeFetchExBitmaps, k as ReturnTypeFetchMultiplePoolTickArrays, S as SDKParsedConcentratedInfo, j as ReturnTypeComputeAmountOut, i as ReturnTypeComputeAmountOutFormat, g as ReturnTypeGetLiquidityAmountOut } from '../../../type-3d09ebbb.js';
import { k as ApiV3PoolInfoConcentratedItem, bL as ReturnTypeFetchMultipleMintInfos, b$ as TokenAmount, c3 as Percent } from '../../../type-f783438f.js';
...
declare class PoolUtils {
    ...
    static computeAmountOutFormat({ poolInfo, tickArrayCache, token2022Infos, amountIn, tokenOut: _tokenOut, slippage, epochInfo, }: {
        poolInfo: ClmmPoolInfo;
        tickArrayCache: {
            [key: string]: TickArray;
        };
